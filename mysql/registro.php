...
<div class="row">
  ...
  <?php
	...
	if(isset($_POST['btn1'])){
		...
		include("abrir_conexion.php"); // en vez de escribir el codigo aca, incluyo el archivo php que esta por separado
		...
		include("cerrar_conexion.php"); // en vez de escribir el codigo aca, incluyo el archivo php que esta por separado
	}
